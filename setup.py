...
plugin_author = "Tom Markula"

# The plugin's author's mail address.
plugin_author_email = "peterotzi79@gmail.com"
...
try:
    ...
    print("Could not import OctoPrint's setuptools, are you sure you are running under the same python installation that OctoPrint is installed under?")
    import sys
    sys.exit(-1)
...
setup_parameters = octoprint_setuptools.create_plugin_setup_parameters(
    ...
    additional_setup_parameters=additional_setup_parameters
)
